...
const TURN_HOST = process.env.TURN_HOST || process.env.DOMAIN || "192.168.1.15"; // Replace with your computer's local IP address
...
module.exports = {
	...
	CORS_ORIGIN: process.env.CORS_ORIGIN
		...
		: ["http://localhost:824", "http://192.168.1.191:824", "http://192.168.1.191:3000"], // Added your local IP and frontend ports for CORS
